...
var menuDefinitions = []menuDef{
	// ── 系统管理 (dir) ─────────────────────────────────────────
	{Key: "system", Name: "系统管理", Type: "dir", Sort: 0},

	// ── 用户管理 ───────────────────────────────────────────────
	{Key: "user", Parent: "system", Name: "用户管理", Type: "menu", Perms: "system:user:list", Path: "/system/user", Component: "system/user/index", Sort: 1},
	...
	// ── 角色管理 ───────────────────────────────────────────────
	{Key: "role", Parent: "system", Name: "角色管理", Type: "menu", Perms: "system:role:list", Path: "/system/role", Component: "system/role/index", Sort: 2},
	...
	// ── 菜单管理 ───────────────────────────────────────────────
	{Key: "menu", Parent: "system", Name: "菜单管理", Type: "menu", Perms: "system:menu:list", Path: "/system/menu", Component: "system/menu/index", Sort: 3},
	...
	// ── 部门管理 ───────────────────────────────────────────────
	{Key: "dept", Parent: "system", Name: "部门管理", Type: "menu", Perms: "system:dept:list", Path: "/system/dept", Component: "system/dept/index", Sort: 4},
	...
	// ── 日志管理 (dir) ─────────────────────────────────────────
	{Key: "log", Parent: "system", Name: "日志管理", Type: "dir", Sort: 5},

	// ── 操作日志 ───────────────────────────────────────────────
	{Key: "operlog", Parent: "log", Name: "操作日志", Type: "menu", Perms: "system:log:operation:list", Path: "/monitor/operlog", Component: "monitor/operlog/index", Sort: 1},
	...
	// ── 登录日志 ───────────────────────────────────────────────
	{Key: "loginlog", Parent: "log", Name: "登录日志", Type: "menu", Perms: "system:log:login:list", Path: "/monitor/logininfor", Component: "monitor/logininfor/index", Sort: 2},
	{Key: "loginlog:query", Parent: "loginlog", Name: "登录日志查询", Type: "btn", Perms: "system:log:login:list", Sort: 1},

	// ── 字典管理 ───────────────────────────────────────────────
	{Key: "dict", Parent: "system", Name: "字典管理", Type: "menu", Perms: "system:dict:list", Path: "/system/dict", Component: "system/dict/index", Sort: 6},
	...
	// ── 参数配置 ───────────────────────────────────────────────
	{Key: "config", Parent: "system", Name: "参数配置", Type: "menu", Perms: "system:config:list", Path: "/system/config", Component: "system/config/index", Sort: 6},
	...
	// ── 通知公告 ───────────────────────────────────────────────
	{Key: "notice", Parent: "system", Name: "通知公告", Type: "menu", Perms: "system:notice:list", Path: "/system/notice", Component: "system/notice/index", Sort: 7},
	...
	// ── 文件管理 ───────────────────────────────────────────────
	{Key: "file", Parent: "system", Name: "文件管理", Type: "menu", Perms: "system:file:list", Path: "/system/file", Component: "system/file/index", Sort: 8},
	...
	// ── 定时任务管理 ──────────────────────────────────────────
	{Key: "job", Parent: "system", Name: "定时任务", Type: "menu", Perms: "system:job:list", Path: "/system/job", Component: "system/job/index", Sort: 9},
	...
	// ── 服务监控 (dir) ─────────────────────────────────────────
	{Key: "monitor", Parent: "system", Name: "服务监控", Type: "dir", Sort: 10},
	{Key: "monitor:server", Parent: "monitor", Name: "服务器监控", Type: "menu", Perms: "system:server:list", Path: "/monitor/server", Component: "monitor/server/index", Sort: 1},
	{Key: "monitor:pprof", Parent: "monitor", Name: "pprof", Type: "menu", Perms: "system:pprof:list", Path: "/monitor/pprof", Component: "monitor/pprof/index", Sort: 2},
	...
	{Key: "monitor:cache", Parent: "monitor", Name: "缓存管理", Type: "menu", Perms: "system:cache:list", Path: "/monitor/cache", Component: "monitor/cache/index", Sort: 3},
	...
	{Key: "monitor:sql", Parent: "monitor", Name: "SQL监控", Type: "menu", Perms: "system:sql:list", Path: "/monitor/sql", Component: "monitor/sql/index", Sort: 4},
}
