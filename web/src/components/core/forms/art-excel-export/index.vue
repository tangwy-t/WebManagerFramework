...
<template>
  <ArtButtonTable
    :icon="isExporting ? 'ri:loader-4-line' : 'ri:file-download-line'"
    :iconClass="isExporting ? 'bg-g-300/55 text-g-700 animate-spin' : 'bg-theme/12 text-theme'"
    :title="isExporting ? loadingText : buttonText"
    @click="handleExport"
  />
</template>
